...
const baseUrl = "http://localhost:3000"
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='w-full max-w-4xl p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto my-3'>
          ...
          <TextInput label="Enter Amount of Stock to Transfer " name="transferStockQty" register={register}  errors={errors} className='w-full' />

          <SelectInput name="receivingBranchId" label="Select the Branch that will receive the stock" register={register}  className='w-full'
                      options={branches}
